...
export type CreateTransactionInput = z.infer<typeof createTransactionSchema>; // this is the type that we will use in the service layer to validate the data that we get from the controller and then we will pass it to the repository layer