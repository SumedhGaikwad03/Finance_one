 ...
 */
export const resolveDateRange = (intent, referenceDate = new Date()) => {
    ...
    switch (intent.type) {
        case "RELATIVE": {
            ...
            switch (intent.unit) {
                case "DAY":
                    startDate.setDate(startDate.getDate() - (intent.amount - 1));
                    break;
                case "WEEK":
                    ...
                    break;
                case "MONTH":
                    startDate.setMonth(startDate.getMonth() - intent.amount);
                    break;
                case "YEAR":
                    startDate.setFullYear(startDate.getFullYear() - intent.amount);
                    break;
            }
            return {
                startDate,
